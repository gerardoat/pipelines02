...
echo "Host: $host"
echo "Nombre reporte: $nombrereporte"
...
./azcopy copy "./report" "https://resulttests.blob.core.windows.net/%24web/rep/$nombrereporte?sv=2019-10-10&st=2020-09-20T18%3A38%3A00Z&se=2020-12-31T19%3A38%3A00Z&sr=c&sp=rwl&sig=PA9SPfvV5HeCaSEMR6NL4HCfw%2FWNU%2Fkq5DJVr1DfpS4%3D" --recursive=true
nuevoReporte="Build $nombrereporte"
uriReporte=""